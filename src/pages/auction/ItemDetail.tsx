    ...
    return (
      <PageShell maxWidth="6xl">
        <div className="rounded-3xl border border-ink/10 bg-white p-5 sm:p-8">
          ...
          <Link to="/bidding" className="mt-5 inline-flex rounded-none border border-ink/20 px-4 py-2 text-xs font-semibold text-ink hover:bg-[#eef3ff] hover:text-neon transition duration-200">
      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            {mainImage ? (
              <>
                <div className="relative flex aspect-[4/3] w-full max-w-[42rem] items-center justify-center overflow-hidden rounded-none border border-ink/10 bg-white p-3 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
                  <img
              ...
              <div className="aspect-[4/3] w-full max-w-[42rem] rounded-none border border-ink/10 bg-ink/5" />
            )}
          </div>
          ...
          <div className="rounded-3xl border border-ink/10 bg-white p-5 sm:p-6">
            ...
            {isAdmin && (
              <Link
                ...
                className="mt-5 inline-flex rounded-none border border-ink/20 px-4 py-2 text-xs font-semibold text-ink hover:bg-[#eef3ff] hover:text-neon transition duration-200"
              >
                Edit item
              </Link>
            )}
